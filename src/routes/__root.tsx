...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Vyshnav C P — CSE student building intelligent systems and scalable web apps with Python, Django, and Deep Learning." },
      { name: "author", content: "Vyshnav C P" },
